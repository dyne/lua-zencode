...
cat whenCompleteScriptGiven.zen whenCompleteScriptPart1.zen \
       | zexe when1.zen -a  myLargeNestedObjectWhen.json | save . whenCompleteOutputPart1.json 
...
cat whenCompleteScriptGiven.zen whenCompleteScriptPart2.zen \
       | zexe when2.zen -a  myLargeNestedObjectWhen.json | save . whenCompleteOutputPart2.json 
...
cat whenCompleteScriptGiven.zen whenCompleteScriptPart3.zen \
       | zexe when3.zen -a  myLargeNestedObjectWhen.json | save . whenCompleteOutputPart3.json 
...
cat whenCompleteScriptGiven.zen whenCompleteScriptPart4.zen \
       | zexe when4.zen -a  myLargeNestedObjectWhen.json | save . whenCompleteOutputPart4.json 
